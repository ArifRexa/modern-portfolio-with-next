  ...
  return (
    <>
      ...
      <div className="flex">
        ...
        <main className={`flex-1 min-h-screen flex flex-col px-6 transition-all duration-300 ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-100'} ${sidebarOpen ? 'opacity-50 lg:opacity-100' : ''}`}>
