...
const StatCard = ({ title, value, color, theme }) => (
  <div className={`relative text-center rounded-xl border backdrop-blur-md px-2 py-4 shadow-sm ${theme === 'dark' ? 'bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700/50' : 'bg-gradient-to-br from-gray-200 to-gray-300 border-gray-300/50'}`}>
    <div className={`text-2xl font-bold ${color}`}>{value}</div>
    <div className={`text-base font-bold ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>{title}</div>
  </div>
);

const SubmissionItem = ({ title, details, verdict, theme }) => (
  <div className={`relative rounded-xl border backdrop-blur-md px-2 py-4 shadow-sm ${theme === 'dark' ? 'bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700/50' : 'bg-gradient-to-br from-gray-200 to-gray-300 border-gray-300/50'}`}>
    <div className="px-2">
      <div className="flex items-center justify-between">
        <div>
          <h6 className={`font-semibold text-md ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>{title}</h6>
          <div className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>{details}</div>
        </div>
        <div
...
const ContestItem = ({ title, details, rank, theme }) => (
  <div className={`relative rounded-xl border backdrop-blur-md px-2 py-4 shadow-sm ${theme === 'dark' ? 'bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700/50' : 'bg-gradient-to-br from-gray-200 to-gray-300 border-gray-300/50'}`}>
    <div className="px-2">
      <div className="flex items-center justify-between">
        <div>
        ...
        <div className={`text-sm rounded-lg ml-8 px-2 py-1 whitespace-nowrap ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>
          Rank: {rank}
        </div>
      </div>
    </div>
    ...
    <section className="space-y-6">
      ...
      <div className={`${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-100'} backdrop-blur-md rounded-xl border ${theme === 'dark' ? 'border-gray-700/50' : 'border-gray-300/50'} p-4 lg:p-6 shadow-sm`}>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            ...
            <h3 className={`text-xl font-bold ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>LeetCode Progress</h3>
          </div>
        </div>

        <div className="grid grid-cols-3 gap-2 mb-4">
          <StatCard title="Easy" value={platformData.leetcode.easy_solved} color="text-green-400" theme={theme} />
          <StatCard title="Medium" value={platformData.leetcode.medium_solved} color="text-yellow-400" theme={theme} />
          <StatCard title="Hard" value={platformData.leetcode.hard_solved} color="text-red-400" theme={theme} />
        </div>

        <div className="mb-4">
          <h6 className={`font-semibold mb-2 text-lg ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>Recent Submissions</h6>
        ...
        <div>
          <h6 className={`font-semibold mb-2 text-lg ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>Recent Contests</h6>
      ...
      <div className={`${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-100'} backdrop-blur-md rounded-xl border ${theme === 'dark' ? 'border-gray-700/50' : 'border-gray-300/50'} p-4 lg:p-6 shadow-sm`}>
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h4 className={`text-xl font-semibold ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>Codeforces Progress</h4>
        </div>

        <div className="grid grid-cols-3 gap-2 mb-4">
          <StatCard title="Problems Solved" value={platformData.codeforces.total_solved} color="text-yellow-400" theme={theme} />
          <StatCard title="Rating" value={platformData.codeforces.rating} color="text-blue-400" theme={theme} />
          <StatCard title="Rank" value={platformData.codeforces.rank} color="text-red-400" theme={theme} />
        </div>
      ...
      <div className={`${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-100'} backdrop-blur-md rounded-xl border ${theme === 'dark' ? 'border-gray-700/50' : 'border-gray-300/50'} p-4 lg:p-6 shadow-sm`}>
        <div className="flex items-center space-x-2 mb-4">
          <div className="w-10 h-10 bg-red-500 rounded flex items-center justify-center">
            <span className={`text-sm font-bold ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>UVa</span>
          </div>
          <h4 className={`text-xl font-semibold ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>UVa Progress</h4>
        </div>

        <div className="grid grid-cols-3 gap-2 mb-4">
          <StatCard title="Problems Solved" value={platformData.uva.total_solved} color="text-yellow-400" theme={theme} />
          <StatCard title="Submissions" value={platformData.uva.submission_count} color="text-blue-400" theme={theme} />
          <StatCard title="AC Rate" value={platformData.uva.ac_rate} color="text-green-400" theme={theme} />
        </div>
        ...
        <div className="mt-2 text-sm text-right">
          <a
            ...
            className={`flex items-center justify-end gap-1 ${theme === 'dark' ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-500'}`}
          >
      ...
      {/* Other Platforms */}
      <div className={`${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-100'} backdrop-blur-md rounded-xl border ${theme === 'dark' ? 'border-gray-700/50' : 'border-gray-300/50'} p-4 lg:p-6 shadow-sm`}>
        <h3 className={`text-2xl font-bold tracking-tight ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'} mb-4`}>Other Platforms</h3>
        <div className="grid grid-cols-2 gap-4">
          <div className={`relative text-center rounded-xl border backdrop-blur-md px-2 py-4 shadow-sm ${theme === 'dark' ? 'bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700/50' : 'bg-gradient-to-br from-gray-200 to-gray-300 border-gray-300/50'}`}>
            ...
            <div className={`text-sm font-semibold ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Rating: {platformData.others.atcoder.rating}</div>
          </div>
          <div className={`relative text-center rounded-xl border backdrop-blur-md px-2 py-4 shadow-sm ${theme === 'dark' ? 'bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700/50' : 'bg-gradient-to-br from-gray-200 to-gray-300 border-gray-300/50'}`}>
            ...
            <div className={`text-sm font-semibold ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Badges: {platformData.others.hackerrank.badges}</div>
          </div>
        </div>
      </div>
    </section>
