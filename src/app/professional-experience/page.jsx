  ...
  return (
    <section className="space-y-6">
      ...
      <div className="space-y-4">
        {experiences.map((exp) => (
          <div key={exp.id} className="bg-gray-900 backdrop-blur-md rounded-xl border border-gray-700/50 p-4 lg:p-6 shadow-sm">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              ...
              <div className="flex flex-col items-start flex-1">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-200">{exp.title}</h3>
                <div className="flex flex-col sm:flex-row sm:space-x-4 items-start text-center lg:text-left">
                  ...
                  >
                    ...
                    <h2 className="font-medium">{exp.location}</h2>
                  </a>
                </div>
                <div className="flex items-center font-medium text-gray-300 mt-1">
                  ...
                  <ul className="space-y-1">
                    {items.map((item, idx) => (
                      <li key={idx} className="flex items-start text-gray-300">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-right w-4 h-4 mr-2 mt-1 text-green-400 flex-shrink-0">
            ...
            {/* Tools & Technologies */}
            <div className="mt-4">
              <h4 className="text-lg font-semibold mb-2 text-gray-200">Tools and Platforms</h4>
