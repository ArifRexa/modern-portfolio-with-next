    ...
    <aside className={`fixed left-0 top-0 h-screen w-80 z-50 backdrop-blur-md border ${borderClass} shadow-sm transform transition-transform duration-300 lg:translate-x-0 -translate-x-full ${className} lg:static lg:sticky lg:top-0 lg:h-screen lg:overflow-hidden ${sidebarBgClass}`}>
      <div className="p-6">
        ...
        <nav className="space-y-2">
          <Link
            href="/"
            className={`flex items-center space-x-3 py-2 lg:py-2.5 px-4 rounded-xl transition-colors duration-300 ${isActiveRoute('/') ? navItemActiveClass : navItemHoverClass + ' ' + navItemTextClass}`}
          >
          ...
          <Link
            ...
            className={`w-full flex items-center space-x-3 py-2 lg:py-2.5 px-4 rounded-xl transition-colors duration-300 border ${isActiveRoute('/professional-experience') ? navItemActiveClass : `${theme === 'dark' ? 'text-gray-400 hover:text-gray-200 hover:bg-gray-800/30 border-transparent' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-300/30 border-transparent'} text-left`}`}>
          ...
          <Link
            ...
            className={`w-full flex items-center space-x-3 py-2 lg:py-2.5 px-4 rounded-xl transition-colors duration-300 border ${isActiveRoute('/technical-skills') ? navItemActiveClass : `${theme === 'dark' ? 'text-gray-400 hover:text-gray-200 hover:bg-gray-800/30 border-transparent' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-300/30 border-transparent'} text-left`}`}>
          ...
          <Link
            ...
            className={`w-full flex items-center space-x-3 py-2 lg:py-2.5 px-4 rounded-xl transition-colors duration-300 border ${isActiveRoute('/academic-background') ? navItemActiveClass : `${theme === 'dark' ? 'text-gray-400 hover:text-gray-200 hover:bg-gray-800/30 border-transparent' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-300/30 border-transparent'} text-left`}`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24"
              height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
          ...
          <Link
            href="/projects"
            className={`w-full flex items-center space-x-3 py-2 lg:py-2.5 px-4 rounded-xl transition-colors duration-300 border ${isActiveRoute('/projects') ? navItemActiveClass : `${theme === 'dark' ? 'text-gray-400 hover:text-gray-200 hover:bg-gray-800/30 border-transparent' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-300/30 border-transparent'} text-left`}`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24"
              height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
              className="lucide lucide-lightbulb w-5 h-5">
            ...
            <span className="font-medium">Projects &amp; Portfolio</span>
          </Link>
          <Link
            href="/coding-activities"
            className={`w-full flex items-center space-x-3 py-2 lg:py-2.5 px-4 rounded-xl transition-colors duration-300 border ${isActiveRoute('/coding-activities') ? navItemActiveClass : `${theme === 'dark' ? 'text-gray-400 hover:text-gray-200 hover:bg-gray-800/30 border-transparent' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-300/30 border-transparent'} text-left`}`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24"
              height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
          ...
          <Link
            ...
            <span className="font-medium">Awards &amp; Certifications</span>
          </Link>
          <Link
            href="/blogs"
            className={`w-full flex items-center space-x-3 py-2 lg:py-2.5 px-4 rounded-xl transition-colors duration-300 border ${isActiveRoute('/blogs') ? navItemActiveClass : `${theme === 'dark' ? 'text-gray-400 hover:text-gray-200 hover:bg-gray-800/30 border-transparent' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-300/30 border-transparent'} text-left`}`}>
          ...
          <Link
            href="/contact"
            className={`w-full flex items-center space-x-3 py-2 lg:py-2.5 px-4 rounded-xl transition-colors duration-300 border ${isActiveRoute('/contact') ? navItemActiveClass : `${theme === 'dark' ? 'text-gray-400 hover:text-gray-200 hover:bg-gray-800/30 border-transparent' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-300/30 border-transparent'} text-left`}`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
              viewBox="0 0 24 24" fill="none" stroke="currentColor"
              strokeWidth="2"
