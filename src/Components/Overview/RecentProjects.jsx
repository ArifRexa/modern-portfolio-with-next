...
const ProjectCard = ({ project }) => {
  return (
    <div className="bg-gray-900 backdrop-blur-md rounded-xl border border-gray-700/40 h-full p-4 lg:p-4  relative rounded-xl border backdrop-blur-md cursor-pointer shadow-md bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700/40 h-full" style={{height: 'auto'}}>
