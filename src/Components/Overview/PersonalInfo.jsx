...
const PersonalInfo = () => {
    return (
        <div className="bg-gray-900 backdrop-blur-md rounded-xl border border-gray-700/50 p-4 lg:p-6 shadow-sm">
            <div className="flex flex-col md:flex-row lg:items-start lg:justify-between w-full relative">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <svg class="w-3.5 h-3.5 fill-current" viewBox="0 0 20 20"><path d="M10 2a5 5 0 00-5 5v1H4a2 2 0 00-2 2v5a2 2 0 002 2h12a2 2 0 002-2v-5a2 2 0 00-2-2h-1V7a5 5 0 00-5-5zm-3 6V7a3 3 0 016 0v1H7z"></path></svg>Available for Hire
                            </div>
                        </div>
                    </div>
            ...
            <section aria-label="Today&#x27;s Stats" className="mt-8 pt-8 border-t border-gray-800">
