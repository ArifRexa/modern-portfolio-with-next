            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-3">
                <div
                    ...
                    <div className="flex items-center space-x-3 mb-3">
                        ...
                        <div>
                            <div className="font-semibold text-gray-200">GitHub</div>
                            <div className="text-xs text-gray-400">@arifrexa</div>
                        </div>
                    </div>
                    <div className="space-y-1 text-sm">
                        <div className="flex justify-between"><span
                            className="font-medium text-gray-300">Repositories</span><span
                                className="font-medium text-gray-300">258</span></div>
                        <div className="flex justify-between"><span
                            className="font-medium text-gray-300">Stars</span><span
                                className="font-medium text-gray-300">18</span></div>
                    </div>
                </div>
                <div
                    className="bg-gray-900 backdrop-blur-md rounded-xl border border-gray-700/50 p-4 lg:p-6 shadow-sm  relative rounded-xl p-4 lg:p-4 border backdrop-blur-md shadow-md bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700/40 h-full">
                    <div className="flex items-center space-x-3 mb-3">
                        ...
                        <div>
                            <div className="font-semibold text-gray-200">CodeForces</div>
                            <div className="text-xs text-gray-400">newbie</div>
                        </div>
                    </div>
                    <div
                        className="space-y-1 text-sm">
                        <div className="flex justify-between"><span
                            className="font-medium text-gray-300">Rating</span><span
                                className="font-medium text-gray-300">1011</span></div>
                        <div className="flex justify-between"><span
                            className="font-medium text-gray-300">Max Rating</span><span
                                className="font-medium text-gray-300">1428</span></div>
                    </div>
                </div>
                <div
                    className="bg-gray-900 backdrop-blur-md rounded-xl border border-gray-700/50 p-4 lg:p-6 shadow-sm  relative rounded-xl p-4 lg:p-4 border backdrop-blur-md shadow-md bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700/40 h-full">
                    <div className="flex items-center space-x-3 mb-3">
                        ...
                        <div>
                            <div className="font-semibold text-gray-200">LeetCode</div>
                            <div className="text-xs text-gray-400">Ranking: 1474378</div>
                        </div>
                    </div>
                    <div
                        className="space-y-1 text-sm">
                        <div className="flex justify-between"><span
                            className="font-medium text-gray-300">Solved</span><span
                                className="font-medium text-gray-300">91</span></div>
                        <div className="flex justify-between"><span
                            className="font-medium text-gray-300">AC Rate</span><span
                                className="font-medium text-gray-300">85%</span></div>
                        <div className="flex justify-between"><span
                            className="font-medium text-gray-300">Contest Rating</span><span
                                className="font-medium text-gray-300">1734</span></div>
                    </div>
                </div>
                <div
                    className="bg-gray-900 backdrop-blur-md rounded-xl border border-gray-700/50 p-4 lg:p-6 shadow-sm  relative rounded-xl p-4 lg:p-4 border backdrop-blur-md shadow-md bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700/40 h-full">
                    <div className="flex items-center space-x-3 mb-3">
                        ...
                        <div>
                            <div className="font-semibold text-gray-200">Stack Overflow</div>
                            <div className="text-xs text-gray-400">Reputation: 372</div>
                        </div>
                    </div>
                    <div className="space-y-1 text-sm">
                        <div className="flex justify-between"><span
                            className="font-medium text-gray-300">Questions</span><span
                                className="font-medium text-gray-300">4</span></div>
                        <div className="flex justify-between"><span
                            className="font-medium text-gray-300">Answers</span><span
                                className="font-medium text-gray-300">30</span></div>
                        <div className="flex justify-between"><span
                            className="font-medium text-gray-300">Badges</span><span
                                className="font-medium text-gray-300">15</span></div>
                    </div>
                </div>
            </div>
        </div>
